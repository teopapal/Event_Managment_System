...
public class DBManager {
    ...
    public static boolean registerCustomer(String name, String email, String creditCardNumber) {
        if (name.isEmpty() || email.isEmpty() || creditCardNumber.isEmpty()) {
        ...
        String insertQuery = "INSERT INTO Customers (name, email, credit_card_details) VALUES (?, ?, ?)";
        ...
        try (PreparedStatement insertCustomer = con.prepareStatement(insertQuery)) {
            ...
            insertCustomer.setString(3, creditCardNumber);
